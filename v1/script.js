...
async function loadFacts() {
  const res = await fetch(
    "https://oumlpcigyaxthoarpndt.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im91bWxwY2lneWF4dGhvYXJwbmR0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODQ3ODQzNzIsImV4cCI6MjAwMDM2MDM3Mn0.Pu1qPHNmwF1yXxKT3lglASlfERNLAc3XslbXCcDV1v0",
      },
    }
  );
